            ...
            public void run() {
                ...
                try {
                    ...
                    s2.setBackground(new Color(102,102,102));
                     String systart = "INSERT INTO `log`(`accountId`,`user`, `activitytype`, `description`) VALUES ('0','System','System Start','System Started')";
                    DB.iud(systart);
                    Thread.sleep(500);
                    ...
                    s3.setBackground(new Color(102,102,102));
                    Thread.sleep(500);
                    ...
                    s4.setBackground(new Color(102,102,102));
                    Thread.sleep(500);
                 
                    s5.setBackground(new Color(102,102,102));
                    pnlclose();
